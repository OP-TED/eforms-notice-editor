...
// field.put(KEY_XPATH_ABS,
// "/*/cac:BusinessParty/cac:PartyLegalEntity/cbc:CompanyID[@schemeName =
// 'EU']/cbc:CompanyID[@schemeName = 'EU']");
...
// field.put(KEY_PARENT_NODE_ID, ND_LOCAL_ENTITY);
// field.put(KEY_XPATH_ABS,
// "/*/cac:BusinessParty/cac:PartyLegalEntity/cbc:CompanyID[not(@schemeName =
// 'EU')]/cbc:CompanyID[not(@schemeName = 'EU')]");
